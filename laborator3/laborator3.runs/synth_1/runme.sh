...
HD_PWD='C:/Users/user/Desktop/AN 3/SEM 1/structure of computer systems/laborator3/laborator3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carrylookahead.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carrylookahead.tcl
