...
HD_PWD='C:/Users/user/Desktop/AN 3/SEM 1/structure of computer systems/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_adder_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_adder_subtractor.tcl
