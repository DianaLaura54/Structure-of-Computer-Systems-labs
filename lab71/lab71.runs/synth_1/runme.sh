...
HD_PWD='C:/Users/user/Desktop/AN 3/SEM 1/structure of computer systems/lab71/lab71.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sliding_window_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sliding_window_adder.tcl
