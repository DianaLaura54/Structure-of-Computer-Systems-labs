...
HD_PWD='C:/Users/user/Desktop/AN 3/SEM 1/structure of computer systems/laboratorfifo/laboratorfifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_fifo_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_fifo_memory.tcl
