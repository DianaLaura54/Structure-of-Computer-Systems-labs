...
HD_PWD='C:/Users/user/Desktop/AN 3/SEM 1/structure of computer systems/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_stimulus_file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_stimulus_file.tcl
